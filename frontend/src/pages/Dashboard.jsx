...
<div className="max-w-6xl mx-auto py-6 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 px-4">
  {properties.length > 0 ? (
    ...
    <p className="text-center text-gray-500 col-span-4">No properties found.</p>
      ...
      {/* Footer */}
      <footer className="text-center py-6 bg-white mt-auto">
        <p className="text-black">Contact Us: info@FindMySpace.com</p>
        <div className="flex justify-center space-x-4 mt-2">
          <Link to="#"><img src="/assets/instagram.ico" alt="Instagram" className="w-6" /></Link>
          <Link to="#"><img src="/assets/facebook.ico" alt="Facebook" className="w-6" /></Link>
          <Link to="#"><img src="/assets/twitter.ico" alt="Twitter" className="w-6" /></Link>
        </div>
      </footer>
    </div>
  );
